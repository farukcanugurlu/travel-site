  ...
  return (
    <>
      <div className="d-flex justify-content-between align-items-center mb-10">
        <h4 className="tg-filter-title mb-0">Destination</h4>
        <Link className="tg-filter-clear" to="#">
          Clear All
        </Link>
      </div>

      <div className="tg-filter-booking-form">
        {/* Destinations (liste güncellendi) */}
        <div className="tg-booking-form-parent-inner tg-hero-quantity p-relative mb-5">
          <span className="tg-booking-form-title">Destinations:</span>
          <div className="tg-booking-add-input-field tg-booking-quantity-toggle">
          ...
          <div className="tg-booking-form-location-list tg-booking-quantity-active">
        ...
        {/* Aşağıdaki bloklar orijinal Hotel Grid Two düzeninin parçası; dokunmuyoruz */}
        <div className="tg-booking-form-parent-inner mb-5">
        ...
        <div className="tg-booking-form-parent-inner tg-hero-quantity p-relative mb-15">
          ...
          <div className="tg-booking-form-location-list tg-quantity tg-booking-quantity-active">
            <ul>
              <li>
                <span className="mr-20">Rooms</span>
              ...
              <li>
                <span className="mr-20">Adults</span>
                <div className="tg-booking-quantity-item">
                  <span className="increment">
                    <svg
                      width="15"
            ...
            <div className="tg-booking-form-search-btn mt-15 ">
              <button className="bk-search-button w-100" type="submit">
                Ok
              </button>
            </div>
          </div>
