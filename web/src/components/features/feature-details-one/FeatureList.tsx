...
const FeatureList = ({ tour }: FeatureListProps) => {
  const durationIcon = (<><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const typeIcon = (<><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const groupSizeIcon = (<><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const languagesIcon = (<><svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const list_data: DataType[] = [
    {
      ...
      icon: durationIcon,
      sub_title: "Duration",
      title: tour.duration || "Full Day",
    },
    {
      id: 2,
      icon: typeIcon,
      sub_title: "Type",
      title: tour.type || "Adventure",
    },
    {
      id: 3,
      icon: groupSizeIcon,
      sub_title: "Group Size",
      title: tour.groupSize || "50 People",
    },
    {
      id: 4,
      icon: languagesIcon,
      sub_title: "Languages",
      title: tour.languages && tour.languages.length > 0 
        ? tour.languages.join(", ") 
        : tour.packages && tour.packages.length > 0
        ? [...new Set(tour.packages.map(pkg => pkg.language))].join(", ")
        : "English",
    },
  ];
