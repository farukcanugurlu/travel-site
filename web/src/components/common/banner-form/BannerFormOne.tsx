      ...
      <div className="tg-booking-form-input-group d-flex align-items-end justify-content-between">
        <div className="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-10">
          ...
          <div
            ...
            className={`tg-booking-add-input-field tg-booking-quantity-toggle ${
              location ? "active" : ""
            } `}
          >
            ...
            <span className="tg-booking-title-value">California City</span>
            <span className="angle-down">
              ...
              >
                <path
                  d="M1.6665 1L6.99984 6.33333L12.3332 1"
                  stroke="#353844"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          <div
            className={`tg-booking-form-location-list tg-booking-quantity-active ${
              location ? "tg-list-open" : ""
            }`}
          >
        ...
        <div className="tg-booking-form-parent-inner tg-hero-quantity p-relative mr-15 mb-10">
          ...
          <div
            className={`tg-booking-form-location-list tg-quantity tg-booking-quantity-active ${
              guest ? "tg-list-open" : ""
            }`}
          >
            <ul>
