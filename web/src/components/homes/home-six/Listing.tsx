...
const Listing = () => {
   ...
   return (
      <div className="tg-listing-area pt-110 pb-115 p-relative z-index-9">
         <img className="tg-listing-3-shape tg-listing-4-shape d-none d-xl-block" src="/assets/img/banner/banner-2/shape.png" alt="" />
         <div className="container">
            <div className="row align-items-end">
               ...
               <div className="col-lg-3">
                  <div className="tg-location-3-btn text-end wow fadeInUp mb-40" data-wow-delay=".6s" data-wow-duration=".9s">
                     <Link to="/tour-details" className="tg-btn tg-btn-gray tg-btn-switch-animation">
            ...
            <div className="row">
               <div className="col-12">
                  <Swiper {...setting} modules={[Autoplay, Pagination]} wrapperClass="mb-35" className="swiper-container tg-listing-slider p-relative fix mb-35">
                        ...
                        <SwiperSlide key={item.id} className="swiper-slide">
                           <div className="tg-listing-card-item tg-listing-4-card-item mb-25">
                              ...
                              <div className="tg-listing-card-content p-relative">
                                 <h4 className="tg-listing-card-title mb-5"><Link to="/tour-grid-1">{item.title}</Link></h4>
                                 ...
                                 <div className="tg-listing-avai d-flex align-items-center justify-content-between">
                                    <Link className="tg-listing-avai-btn" to="#">Check Availability</Link>
