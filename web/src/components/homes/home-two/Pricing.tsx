...
const Pricing = () => {
   return (
      <div className="tg-pricing-area tg-pricing-su-wrap pb-100 pt-130 p-relative z-index-1">
         <img className="tg-pricing-su-shape d-none d-md-block p-absolute" src="/assets/img/pricing/shape.png" alt="" />
         <img className="tg-pricing-su-shape-2 p-absolute d-none d-md-block" src="/assets/img/pricing/shape-2.png" alt="" />
