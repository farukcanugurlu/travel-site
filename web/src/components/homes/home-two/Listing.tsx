...
const Listing = () => {
   ...
   return (
      <div className="tg-listing-area pt-120 pb-120 p-relative">
         <img className="tg-listing-su-2-shape p-absolute d-none d-xxl-block" src="/assets/img/listing/su/shape-3.png" alt="" />
            ...
            <div className="row">
                  ...
                  <div key={item.id} className="col-xl-4 col-lg-4 col-md-6">
                     <div className="tg-listing-card-item tg-listing-su-card-item mb-25">
                        ...
                        <div className="tg-listing-card-content">
                           ...
                           <h4 className="tg-listing-card-title mb-10"><Link to="tour-details.html">{item.title}</Link></h4>
               ...
               <div className="col-12">
                  <div className="text-center mt-15">
                     <Link to="/tour-grid-1" className="tg-btn tg-btn-transparent tg-btn-su-transparent">See More Tours</Link>
                  </div>
               </div>
            </div>
         </div>
