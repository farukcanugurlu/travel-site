...
async function main() {
  ...
  // Test destinasyonları oluştur (koordinatlarla)
  const destinations = [
  ...
  // Test kullanıcıları oluştur (review'lar için)
  const testUsers = [
    {
  ...
  // Test turları oluştur (tam dolu, çok fotoğraflı)
  const testTours = [
    {
    ...
    if (!existing) {
      const tour = await prisma.tour.create({
        data: {
          ...
          included: tourData.included as any,
          excluded: tourData.excluded as any,
          highlights: tourData.highlights as any,
          itinerary: tourData.itinerary as any,
          ...
          languages: tourData.languages as any,
